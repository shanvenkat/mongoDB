myapp.controller ('usersController', function ($scope, $http,$location) {
    ...
    $scope.adduser = function () {        
        ...
        var kids = $scope.user.kids;
        var adults = $scope.user.adults;
        //alert ("kids " + kids);
         //alert ("adults  " + adults);

        //alert ('dob# ' + dob)
        $http.post('/adduser/'+ firstname +'/' + lastname + '/' + branch + '/' + gender + '/' + age +'/' + kids + '/'  + adults + '/' + dob +'/' + emptype + '/' + email +'/' )
            .success(function (data) {                 
...
myapp.controller ('updateController', function ($scope, $http, $routeParams, $location, $filter) {
    ...
    $scope.updateuser = function (docid, strfirstname,  strlastname,  strbranch, strgender, strage, strkids, stradults, strdob, stremptype,  stremail) {
